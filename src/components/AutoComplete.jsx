  ...
  return (
    <div className="relative z-50">
      ...
      >
        ...
        <button
          type="submit"
          className="text-xs bg-slate-900 text-slate-300 w-[3.5rem] h-[2rem] px-2 py-1 rounded-r-lg text-center absolute right-0 hover:bg-slate-700"
        >
          검색
        </button>
      </form>
